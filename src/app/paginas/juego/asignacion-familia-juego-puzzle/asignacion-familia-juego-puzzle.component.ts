...
@Component({
  selector: 'app-asignacion-familia-juego-puzzle',
  templateUrl: './asignacion-familia-juego-puzzle.component.html',
  styleUrls: ['./asignacion-familia-juego-puzzle.component.scss']
})
export class AsignacionFamiliaJuegoPuzzleComponent implements OnInit {
  ...
  TraeListaDeImagenes() {
    ...
    this.peticionesAPI.DameFamiliasDeImagenesDePuzzleProfesor(this.profesorId)
      .subscribe(familias => {
